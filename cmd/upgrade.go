...
func getVersionsFromGithub() (versions []*version.Version, err error) {
	...
	tags, _, err := gh.Repositories.ListTags(ctx, "gumieri", "p", &github.ListOptions{})
	if err != nil {
		return
	}
...
func upgradeRun(cmd *cobra.Command, args []string) {
	...
	url := "https://github.com/gumieri/p/releases/download/v" + latest.String() + "/" + u
...
var upgradeCmd = &cobra.Command{
	Use:   "upgrade",
	Short: "Upgrade the p binary to the latest stable release",
	Run:   upgradeRun,
}
